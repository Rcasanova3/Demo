...
- Share creates a branded 1080×1350 foggy-glass PNG (app name, tagline, selected space, selected category, and core message), opens a preview modal, supports download, and shows native file share when available
